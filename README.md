...
The main exhibit page will be placed in *src/pages/storage-evolution.mdx*. The interactive timeline will be placed in *src/components/StorageTimeline.jsx*. Additional visual cards or reusable display sections may be created as Astro components.
